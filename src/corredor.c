...
void init_jogador_corredor(Jogador_corredor* jogador2, int display_height) {
    ...
    jogador2->pos_y = display_height - jogador2->frame_height * jogador2->scale_factor - 40;// Ajuste para que o personagem toque o ch�o
            ...
            if (!jogador2.knocked_back) {
                switch (event.keyboard.keycode) {
                    ...
                    case ALLEGRO_KEY_SPACE:
                        ...
                        break;
                    case ALLEGRO_KEY_F:
                        if (jogador2.pos_x >= 60 && jogador2.pos_x <= 215) {
                            z = 1; 
                            quarto(display, game_state);
                            *game_state = QUARTO;
                            running = false;
                        } else if (jogador2.pos_x >= 545 && jogador2.pos_x <= 670) {
                            z = 2;
                            quarto(display, game_state);
                            *game_state = QUARTO;
                            running = false;
                        } else if (jogador2.pos_x >= 1015 && jogador2.pos_x <= 1160) {
                            z = 3;
