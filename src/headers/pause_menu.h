...
//  *
//  * Essa fun��o pausa o jogo e exibe um menu que permite ao jogador escolher
//  * entre voltar ao menu principal ou retornar � tela de mapa. Ela atualiza
...
//  * - GameState *state: ponteiro para o estado atual do jogo, que ser� modificado
