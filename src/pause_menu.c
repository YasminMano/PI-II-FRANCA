...
// //            printf("Tecla pressionada no menu de pausa: %d\n", event.keyboard.keycode); // Depura��o
//      //       switch (event.keyboard.keycode) {
//   //          case ALLEGRO_KEY_1:
//    //             *state = MENU;
//    //             in_pause_menu = false;
//    //             printf("Op��o 1 selecionada: Voltar ao Menu Principal\n");
//   //              break;
//    //         case ALLEGRO_KEY_2:
//   //              *state = MAPA;
//     //            in_pause_menu = false;
//    //             printf("Op��o 2 selecionada: Voltar ao Mapa\n");
//     //            break;
...
//     // Redesenha o display ap�s sair do menu de pausa
//    // al_clear_to_color(al_map_rgb(0, 0, 0));
//    // al_flip_display();
// //}
