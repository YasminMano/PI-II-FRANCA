...
void banheiro(ALLEGRO_DISPLAY* display) {
    ...
    while (running) {
        ...
        if (event.type == ALLEGRO_EVENT_KEY_DOWN) {  // Detecta quando uma tecla é pressionada
            ...
            // E abri os baus
            else if (event.keyboard.keycode == ALLEGRO_KEY_E && pos_x >= 64 && pos_x <= 264) {// abri o bau 1
                jumping = true;
            }
        }
...
void quarto(ALLEGRO_DISPLAY* display) {
    ...
    while (running) {
        ...
        if (event.type == ALLEGRO_EVENT_KEY_DOWN) {  // Detecta quando uma tecla é pressionada
            ...
            // F abri outra porta
            else if (event.keyboard.keycode == ALLEGRO_KEY_F && pos_x >= 454 && pos_x <= 528) {// porta para voltar
                return -1;
            }
            else if (event.keyboard.keycode == ALLEGRO_KEY_F && pos_x >= 674 && pos_x <= 760) {// porta para o banheiro
                banheiro(display);
            }
            // E abri os baus
            else if (event.keyboard.keycode == ALLEGRO_KEY_E && pos_x >= -40 && pos_x <= 58) {// abri o bau 1
                jumping = true;
            }
            else if (event.keyboard.keycode == ALLEGRO_KEY_E && pos_x >= 1030 && pos_x <= 1154) {// abri o bau 2
                jumping = true;
            }
        }
        else if (event.type == ALLEGRO_EVENT_KEY_UP) {  // Detecta quando uma tecla é solta
